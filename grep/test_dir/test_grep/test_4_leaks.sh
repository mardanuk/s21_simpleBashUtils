...
"-e regex -e ^print ./s21_grep.c VAR -f ./test_dir/test_grep/test_ptrn_grep.txt"
"-e while -e void ./s21_grep.c Makefile VAR -f ./test_dir/test_grep/test_ptrn_grep.txt"
)

declare -a extra=(
"-n for ./test_dir/test_grep/test_1_grep.txt ./test_dir/test_grep/test_2_grep.txt"
"-n for ./test_dir/test_grep/test_1_grep.txt"
...
"-ne = -e out ./test_dir/test_grep/test_5_grep.txt"
"-iv int ./test_dir/test_grep/test_5_grep.txt"
"-in int ./test_dir/test_grep/test_5_grep.txt"
"-c -l aboba ./test_dir/test_grep/test_1_grep.txt ./test_dir/test_grep/test_5_grep.txt"
"-v ./test_dir/test_grep/test_1_grep.txt -e ank"
"-noe ) ./test_dir/test_grep/test_5_grep.txt"
"-l for ./test_dir/test_grep/test_1_grep.txt ./test_dir/test_grep/test_2_grep.txt"
"-o -e int ./test_dir/test_grep/test_4_grep.txt"
"-e = -e out ./test_dir/test_grep/test_5_grep.txt"
"-noe ing -e as -e the -e not -e is ./test_dir/test_grep/test_6_grep.txt"
"-e ing -e as -e the -e not -e is ./test_dir/test_grep/test_6_grep.txt"
"-c -e . ./test_dir/test_grep/test_1_grep.txt -e '.'"
"-l for no_file.txt ./test_dir/test_grep/test_2_grep.txt"
"-f ./test_dir/test_grep/test_3_grep.txt ./test_dir/test_grep/test_5_grep.txt"
)
